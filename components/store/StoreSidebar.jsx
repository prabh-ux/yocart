...
import { HomeIcon, LayoutListIcon, SquarePenIcon, SquarePlusIcon, CircleUserRound } from "lucide-react"
    ...
    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                <CircleUserRound size={56} className="text-slate-400" />
                <p className="text-slate-700">{storeInfo?.name || 'Seller'}</p>
            </div>

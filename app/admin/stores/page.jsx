...
// TODO: store/vendor feature not built yet — using dummy data until store model + routes exist
export default function AdminStores() {
    ...
    const fetchStores = async () => {
        // TODO: replace with real API call once store model exists
        setStores(storesDummyData)
        setLoading(false)
    }

    const toggleIsActive = async (storeId) => {
        // TODO: implement once store model exists
    }

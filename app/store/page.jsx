                        ...
                        <div key={index} className="flex max-sm:flex-col gap-5 sm:items-center justify-between py-6 border-b border-slate-200 text-sm text-slate-600 max-w-4xl">
                            <div>
                                <div className="flex gap-3">
                                    <div className="w-10 aspect-square rounded-full bg-slate-100 flex items-center justify-center text-slate-400 text-xs">
                            ...
                            <div className="flex flex-col justify-between gap-6 sm:items-end">
                                ...
                                <button onClick={() => router.push(`/product/${review.product._id}`)} className="bg-slate-100 px-5 py-2 hover:bg-slate-200 rounded transition-all">View Product</button>
                            </div>
                        </div>
                    ))
                }
